...
on:
  workflow_dispatch:
    inputs:
      agent_name:
        description: 'reyxsinz'
        required: true
        default: 'reyxsinz'
      agent_description:
        description: 'reyxsinz AI Agent'
        required: true
        default: 'reyxsinz AI Agent'
  ...
  verify:
    ...
    steps:
      ...
      - name: Step 3 - Link Human to Agent
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "reyxsinz", "description": "reyxsinz AI Agent"}'